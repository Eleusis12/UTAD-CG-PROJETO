...
$(document).ready(function (e) {
  ...
  function loadSubMenu(mainMenu, mainOptions, _value) {
    ...
    var subOptions =
      "<ul style='display:none;' data-parent-id='" +
      parentId +
  ...
  function showMainMenu() {
    ...
    $.each(mainOptions, function (key, value) {
      ...
      if (config["mainMenu"][value].subMenu != undefined) {
        ...
        mainMenu.append(
          "<li data-type='submenu' data-pos='" +
            key +
            "' id='" +
            config["mainMenu"][value].id +
            "' class='main-menu-opt'>" +
            config["mainMenu"][value].title +
            "</li>"
        );
      } else {
        mainMenu.append(
  ...
  var config = {
    ...
    mainMenu: {
      startGame: {
        ...
        callback: function () {
          showLoading();
          $(location).attr("href", "../game/game.html");
        },
      },
      loadGame: {
        id: "opt-load-game",
